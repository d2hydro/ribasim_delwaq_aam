...
model.basin.static.df = None # op none zetten, want we willen de time-table gaan gebruiken
...
primary_basin_node_ids = model.basin.node.df[model.basin.node.df["meta_categorie"].isin(["hoofdwater", "doorgaand"])].index.values
secondary_basin_node_ids = model.basin.node.df[model.basin.node.df["meta_categorie"].isin(["bergend"])].index.values

primary_drainage = model.basin.time.df[model.basin.time.df.node_id.isin(primary_basin_node_ids)][["time","drainage"]].groupby("time").sum()["drainage"]
primary_infiltration = model.basin.time.df[model.basin.time.df.node_id.isin(primary_basin_node_ids)][["time","infiltration"]].groupby("time").sum()["infiltration"]
...
secondary_drainage = model.basin.time.df[model.basin.time.df.node_id.isin(secondary_basin_node_ids)][["time","drainage"]].groupby("time").sum()["drainage"]
secondary_infiltration = model.basin.time.df[model.basin.time.df.node_id.isin(secondary_basin_node_ids)][["time","infiltration"]].groupby("time").sum()["infiltration"]
